...
public class Kakeibo {
	...
	/** 支出金額 */
	private Integer expendituerAmount;
	/** 収入金額 */
	...
	public Integer getExpendituerAmount() {
		return expendituerAmount;
	}

	public void setExpendituerAmount(Integer expendituerAmount) {
		this.expendituerAmount = expendituerAmount;
	}
	...
	public String toString() {
		return "Kakeibo [id=" + id + ", userId=" + userId + ", settlementDate=" + settlementDate + ", expenseItemId="
				+ expenseItemId + ", expendituerAmount=" + expendituerAmount + ", incomeAmount=" + incomeAmount
